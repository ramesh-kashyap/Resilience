...
Route::get('/register', [App\Http\Controllers\Register::class, 'register_page'])->name('register');
...
Route::post('/registration/payment/submit', [App\Http\Controllers\UserPanel\Dashboard::class, 'submitRegistrationPayment'])
    ->name('registration.payment.submit');
...
Route::post('/WithdrawPrincipalRequest', [App\Http\Controllers\UserPanel\WithdrawRequest::class, 'WithdrawPrincipalRequest'])->name('user.WithdrawPrincipalRequest');
...
//bonus
Route::get('/booster-income', [App\Http\Controllers\UserPanel\Bonus::class, 'booster_bonus'])->name('user.booster-income');

Route::get('/passive-income', [App\Http\Controllers\UserPanel\Bonus::class, 'index'])->name('user.level-income');
...
Route::get('/profit-shering-bonus', [App\Http\Controllers\UserPanel\Bonus::class, 'roi_income'])->name('user.roi-bonus');
...
Route::group(['middleware' => ['admin']], function ()
{
 ...
 Route::get('/totalusers', [App\Http\Controllers\Admin\UserController::class, 'alluserlist'])->name('admin.totalusers');
  Route::get('/admin/withdraw-toggle/{id}', [App\Http\Controllers\Admin\UserController::class, 'withdrawToggle'])->name('admin.withdraw.toggle');
...
//DepositManagmentController
 Route::get('/payment-request', [App\Http\Controllers\Admin\DepositController::class, 'payment_request'])->name('admin.payment-request');
 ...
 Route::get('/payment-list', [App\Http\Controllers\Admin\DepositController::class, 'payment_list'])->name('admin.payment-list');
 ...
 Route::get('payment_request_done', [App\Http\Controllers\Admin\DepositController::class, 'payment_request_done'])->name('admin.payment_request_done');
...
//bonusController
Route::get('passive-bonus', [App\Http\Controllers\Admin\BonusController::class, 'roi_bonus'])->name('admin.roi-bonus');
Route::get('profit-sharing-bonus', [App\Http\Controllers\Admin\BonusController::class, 'level_bonus'])->name('admin.level-bonus');
