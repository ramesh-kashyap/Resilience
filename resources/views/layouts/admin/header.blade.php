            ...
            <div class="deznav-scroll">
                ...
                <li><a href="{{route('admin.add-bonus')}}" class="ai-icon" aria-expanded="false">
                    ...
                    <!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Register Payment </span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.payment-request') }}">Pending Payment</a></li>
                            <li><a href="{{ route('admin.payment-list') }}">Payment reports</a></li>
                ...
                <li><a href="{{route('admin.add-price')}}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.roi-bonus') }}">Passive Income</a></li>
                         <li><a href="{{ route('admin.booster-bonus') }}">Booster Income</a></li>

                             <li><a href="{{ route('admin.level-bonus') }}">Profit sharing Income</a></li>
